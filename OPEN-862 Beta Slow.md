...
| module.getConfigurationGroupsMultiselect                      |      |       | CG     | .16s       | .2       | .6             | .2        |
| module.getConfigurationGroupsOtherColumns                     | X    |       | Other  | .28s       | .2       | .9             | .8        |
| module.getConfigurationGroupsAlerts                           | X    |       | Alerts | 3.3s       | 2.9      | 6.4            | 36        |
| module.getConfigChangedFlagForMobileUnits                     | X    |       | Flag   | .17s       | .2       | .7             | .3        |
| module.getConfigurationGroupsMultiselectAssetsList            |      |       | Assets | 1s         | 3        | 4              | 4.6       |
| module.getConfigurationGroupsMultiselectAssetLinesList        | X    |       | Lines  | 6.8s-12s   | 12.9     | 3              | pending   |
| module.getConfigurationGroupsMultiselectAssetAlertsList       | X    |       | Alerts | 2.5s       | 3        | 7.3            | pending   |
