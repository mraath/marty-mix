...
| [OPEN-2369](https://powerfleet.atlassian.net/browse/OPEN-2369) | Database - Remove configdiff schema from DeviceConfiguration SSDT project | **In Code Review** 🔍 | PostgreSQL migration |
