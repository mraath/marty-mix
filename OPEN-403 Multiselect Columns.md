...
button #assetsColumnChooserButton (anchor) (click)="onToggleGridConfigAssetsColumns()"
kendo-popup #popup class="popup-column-chooser" [anchor]="assetsColumnChooserButton" **(missing .element)**
