...
- [x] Failed to add Camera Name ✅ 2025-09-17
- [x] Failed to edit Camera Name ✅ 2025-09-17
- [x] DEPLOY BE ✅ 2025-09-30
...
- **DB**
	- [x] Update 2 Stored Procs ✅ 2025-08-26
		...
		- [x] [PR to INT](https://dev.azure.com/MiXTelematics/Common/_git/Database/pullrequest/131541) ✅ 2025-10-01
...
- API
	...
	- [x] [PR Client to INT](https://dev.azure.com/MiXTelematics/DeviceIntegration/_git/Config.Api/pullrequest/131554) ✅ 2025-10-28
...
- BE
	...
	- [x] [PR INT](https://dev.azure.com/MiXTelematics/Common/_git/DynaMiX.Backend/pullrequest/131623?_a=files) ✅ 2025-10-28
		- MiX.DeviceIntegration.Common
		- MiX.ConfigInternal.Api.Client.2025.19.20250930.1.nupkg
...
- FE
	...
	- [x] [PR to DEV always change Camera Name](https://dev.azure.com/MiXTelematics/Common/_git/MiX.Fleet.UI/pullrequest/130483) ✅ 2025-09-11
	...
	- [x] [PR Pop Alerts to DEV](https://dev.azure.com/MiXTelematics/Common/_git/MiX.Fleet.UI/pullrequest/130880) ✅ 2025-09-17
	- [x] [PR for OPEN-756 Deleted and Languaged](https://dev.azure.com/MiXTelematics/Common/_git/MiX.Fleet.UI/pullrequest/130974) ✅ 2025-09-18
	- [x] [PR Disable Edit Save DEV](https://dev.azure.com/MiXTelematics/Common/_git/MiX.Fleet.UI/pullrequest/131180) ✅ 2025-09-24
	- [x] [PR fix overflow DEV](https://dev.azure.com/MiXTelematics/Common/_git/MiX.Fleet.UI/pullrequest/131245) ✅ 2025-10-01
	- [x] [PR FE to INT](https://dev.azure.com/MiXTelematics/Common/_git/MiX.Fleet.UI/pullrequest/131624?_a=files) ✅ 2025-10-01
	Template
	- [x] Add Camera Name ✅ 2025-09-01
	- [x] Edit Camera Name ✅ 2025-09-01
...
Where are these being called from:
- [dynamix].[CopyLibraryForNewDatabase]
	- CreateDatabase (copy for groupid)
- [dynamix].[InitializeLibraryForNewBlankDatabase]
	- CreateDatabase (no groupid)
- [library].[CopyCameraNamesAndChannels]
	- Many places in SPROC
	- CopyAndSaveCameraNamesAndChannels
		- Make available... Dependencies... helper
- C:\Projects\Database\DeviceConfiguration\Scripts\DeploymentScripts\MergeCameraData.sql
	- DeploymentTasks.xml

CREATED OPEN-689 for this