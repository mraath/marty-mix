...
BEGIN
    ...
    DECLARE @FM33x0 BIGINT = 6710360414173584261;
    ...
    -- Simplified firmware outdated status calculation
    FirmwareOutdatedStatus AS (
        SELECT 
            ...
            CASE 
                ...
                ELSE 0 -- Simplified logic - set to 0 for now, can be enhanced later
